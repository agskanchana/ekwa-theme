...
function ekwa_script_enqueue(){
    ...
    wp_enqueue_script('customjs', get_template_directory_uri().'/js/custom.js', array(), '1.2.6', true);
     wp_enqueue_script('mmenu', get_template_directory_uri().'/plugins/mm-menu/mmenu-light.js', array(), '1.1.1', true);
...
function ekwa_customizer_control_scripts() {
	...
	wp_enqueue_script( 'ekwa-location-hours', get_template_directory_uri() . '/settings/customizer-settings/js/location-working-hours.js', array( 'jquery', 'customize-controls' ), '1.2.3', true );
