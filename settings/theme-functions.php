...
function ekwa_customizer_control_scripts() {
	...
	wp_enqueue_script( 'ekwa-location-hours', get_template_directory_uri() . '/settings/customizer-settings/js/location-working-hours.js', array( 'jquery', 'customize-controls' ), '1.1.1', true );
