...
<?php
$term = get_term_by('slug', 'service-boxes', 'ekwa-theme-resources-category');
...
<div class="ekwa-admin-page" data-url="<?php echo admin_url('admin-ajax.php');?>" data-type="service-boxes" data-category="<?php echo $term_ID;?>" data-directory="sections/service-boxes">
    
</div>
    <div class="card-header">
        <h1 class="ekwa_admin_heading">Service Area Designs</h1>
    </div>
    <div class="preloader">
        <div class="fa-2x">
